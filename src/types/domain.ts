...
export const mediaCategories = ["Campus", "Classrooms", "Science Laboratory", "ICT Laboratory", "Library", "Sports", "Playground", "Transportation", "Dining", "Kitchen", "Sick Bay", "Toilets", "Boarding", "Security"] as const;
